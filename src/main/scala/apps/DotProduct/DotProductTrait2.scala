...
trait DotProductTrait2 extends DotProductTrait1 {
  ...
  def config2:Unit = {
    ...
    // ob4148[3] -> CtrlBox620.readDone.out
    cus(0)(1).asPMUBits.control.tokenOutXbar.outSelect(3) = 1
    ...
    // ob4096[1] -> CtrlBox602.readDone.out
    cus(1)(0).asPMUBits.control.tokenOutXbar.outSelect(1) = 1
    ...
    // cus(1)(1).asPCUBits.scalarOutXbar=[None,None,None,Some(pr(st6830[8],reg513[8]))]
