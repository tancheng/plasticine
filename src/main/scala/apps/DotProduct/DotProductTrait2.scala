...
trait DotProductTrait2 extends DotProductTrait1 {
  ...
  def config2:Unit = {
    ...
    cus(0)(0).asPCUBits.stages(6).opA = SVT(ReduceTreeSrc, 0)
    cus(0)(0).asPCUBits.stages(6).opB = SVT(ReduceTreeSrc, 0)
    cus(0)(0).asPCUBits.stages(6).opC = SVT()
    cus(0)(0).asPCUBits.stages(6).opcode = FixAdd
    cus(0)(0).asPCUBits.stages(6).res = List(SVT(CurrStageDst, 0))
    cus(0)(0).asPCUBits.stages(6).fwd(0) = SVT(ALUSrc, 6)
    cus(0)(0).asPCUBits.stages(7).opA = SVT(PrevStageSrc, 0)
    cus(0)(0).asPCUBits.stages(7).opB = SVT(CurrStageSrc, 1)
    cus(0)(0).asPCUBits.stages(7).opC = SVT()
    cus(0)(0).asPCUBits.stages(7).opcode = FixAdd
    cus(0)(0).asPCUBits.stages(7).res = List(SVT(CurrStageDst, 1))
    cus(0)(0).asPCUBits.accumInit = 0
    cus(0)(0).asPCUBits.stages(7).fwd(1) = SVT(ALUSrc, 7)
    cus(0)(0).asPCUBits.stages(8).opA = SVT(PrevStageSrc, 1)
    cus(0)(0).asPCUBits.stages(8).opB = SVT()
    cus(0)(0).asPCUBits.stages(8).opC = SVT()
    cus(0)(0).asPCUBits.stages(8).opcode = BypassA
    cus(0)(0).asPCUBits.stages(8).res = List(SVT(CurrStageDst, 8))
    cus(0)(0).asPCUBits.stages(8).fwd(8) = SVT(ALUSrc, 8)
    ...
    cus(0)(1).asPMUBits.control.writeDoneXbar.outSelect(0) = 9
    // ob4212[0] -> CtrlBox620.readDone.out
    cus(0)(1).asPMUBits.control.tokenOutXbar.outSelect(0) = 1
    ...
    cus(1)(0).asPMUBits.control.writeDoneXbar.outSelect(0) = 9
    // ob4164[0] -> CtrlBox602.readDone.out
    cus(1)(0).asPMUBits.control.tokenOutXbar.outSelect(0) = 1
