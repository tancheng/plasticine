...
trait PlasticineArch6 extends PlasticineArch5 {
  def connect6(io:PlasticineIO, argOutMuxIns:Array[Array[DecoupledIO[UInt]]], doneOuts:Array[Bool], cus:Array[Array[CU]], scus:Array[Array[ScalarCU]] , mcs:Array[Array[MemoryChannel]], vsbs:Array[Array[VectorSwitch]], ssbs:Array[Array[ScalarSwitch]], csbs:Array[Array[ControlSwitch]], lcus:Array[Array[SwitchCU]]):Unit = {
    ...
    mcs(0)(0).io.plasticine.controlOut <> scus(0)(0).io.controlIn(4)
    mcs(0)(0).io.plasticine.controlOut <> scus(0)(0).io.controlIn(5)
    mcs(0)(0).io.plasticine.controlOut <> csbs(0)(0).io.ins(4)
    mcs(0)(1).io.plasticine.controlOut <> scus(0)(1).io.controlIn(4)
    mcs(0)(1).io.plasticine.controlOut <> scus(0)(1).io.controlIn(5)
    mcs(0)(1).io.plasticine.controlOut <> csbs(0)(1).io.ins(4)
    mcs(0)(2).io.plasticine.controlOut <> scus(0)(2).io.controlIn(4)
    mcs(0)(2).io.plasticine.controlOut <> scus(0)(2).io.controlIn(5)
    mcs(0)(2).io.plasticine.controlOut <> csbs(0)(2).io.ins(4)
    mcs(1)(0).io.plasticine.controlOut <> csbs(2)(0).io.ins(17)
    mcs(1)(0).io.plasticine.controlOut <> scus(1)(0).io.controlIn(4)
    mcs(1)(0).io.plasticine.controlOut <> scus(1)(0).io.controlIn(5)
    mcs(1)(1).io.plasticine.controlOut <> csbs(2)(1).io.ins(17)
    mcs(1)(1).io.plasticine.controlOut <> scus(1)(1).io.controlIn(4)
    mcs(1)(1).io.plasticine.controlOut <> scus(1)(1).io.controlIn(5)
    mcs(1)(2).io.plasticine.controlOut <> csbs(2)(2).io.ins(13)
    mcs(1)(2).io.plasticine.controlOut <> scus(1)(2).io.controlIn(4)
    mcs(1)(2).io.plasticine.controlOut <> scus(1)(2).io.controlIn(5)
    ...
    csbs(0)(0).io.outs(4) <> mcs(0)(0).io.plasticine.controlIn
