...
trait PlasticineArch0{
  ...
  ssbs(0)(2) = Module(new ScalarSwitch(ScalarSwitchParams(numIns=14, numOuts=14, w=32)))
  ...
  ssbs(1)(0) = Module(new ScalarSwitch(ScalarSwitchParams(numIns=19, numOuts=19, w=32)))
  ...
  ssbs(1)(2) = Module(new ScalarSwitch(ScalarSwitchParams(numIns=19, numOuts=19, w=32)))
  ...
  ssbs(2)(0) = Module(new ScalarSwitch(ScalarSwitchParams(numIns=14, numOuts=14, w=32)))
  ...
  ssbs(2)(2) = Module(new ScalarSwitch(ScalarSwitchParams(numIns=14, numOuts=14, w=32)))
