...
trait PlasticineArch3 extends PlasticineArch2 {
  def connect3(io:PlasticineIO, argOutMuxIns:Array[Array[DecoupledIO[UInt]]], doneOuts:Array[Bool], cus:Array[Array[CU]], scus:Array[Array[ScalarCU]] , mcs:Array[Array[MemoryChannel]], vsbs:Array[Array[VectorSwitch]], ssbs:Array[Array[ScalarSwitch]], csbs:Array[Array[ControlSwitch]], lcus:Array[Array[SwitchCU]]):Unit = {
    ...
    scus(1)(0).io.scalarOut(0) <> ssbs(2)(0).io.ins(9)
    scus(1)(0).io.scalarOut(1) <> ssbs(2)(0).io.ins(10)
    scus(1)(0).io.scalarOut(2) <> ssbs(2)(0).io.ins(11)
    scus(1)(0).io.scalarOut(3) <> ssbs(2)(0).io.ins(12)
    scus(1)(0).io.scalarOut(4) <> mcs(1)(0).io.plasticine.scalarIn(0)
    scus(1)(0).io.scalarOut(5) <> mcs(1)(0).io.plasticine.scalarIn(1)
    scus(1)(1).io.scalarOut(0) <> ssbs(2)(1).io.ins(9)
    scus(1)(1).io.scalarOut(1) <> ssbs(2)(1).io.ins(10)
    scus(1)(1).io.scalarOut(2) <> ssbs(2)(1).io.ins(11)
    scus(1)(1).io.scalarOut(3) <> ssbs(2)(1).io.ins(12)
    ...
    ssbs(0)(0).io.outs(4) <> ssbs(0)(1).io.ins(14)
    ssbs(0)(0).io.outs(5) <> ssbs(0)(1).io.ins(15)
    ssbs(0)(0).io.outs(6) <> ssbs(0)(1).io.ins(16)
    ssbs(0)(0).io.outs(7) <> ssbs(0)(1).io.ins(17)
    ...
    ssbs(0)(1).io.outs(4) <> ssbs(0)(2).io.ins(12)
    ssbs(0)(1).io.outs(5) <> ssbs(0)(2).io.ins(13)
    ssbs(0)(1).io.outs(6) <> ssbs(0)(2).io.ins(14)
    ssbs(0)(1).io.outs(7) <> ssbs(0)(2).io.ins(15)
    ...
    ssbs(0)(1).io.outs(20) <> ssbs(0)(0).io.ins(6)
    ssbs(0)(1).io.outs(21) <> ssbs(0)(0).io.ins(7)
    ...
    ssbs(0)(2).io.outs(4) <> argOutMuxIns(0)(3)
    ssbs(0)(2).io.outs(4) <> argOutMuxIns(1)(3)
    ssbs(0)(2).io.outs(4) <> argOutMuxIns(2)(3)
    ssbs(0)(2).io.outs(5) <> ssbs(1)(2).io.ins(0)
    ssbs(0)(2).io.outs(6) <> ssbs(1)(2).io.ins(1)
    ssbs(0)(2).io.outs(7) <> ssbs(1)(2).io.ins(2)
    ssbs(0)(2).io.outs(8) <> ssbs(1)(2).io.ins(3)
    ssbs(0)(2).io.outs(9) <> lcus(0)(2).io.scalarIn(0)
    ssbs(0)(2).io.outs(10) <> lcus(0)(2).io.scalarIn(1)
    ssbs(0)(2).io.outs(11) <> lcus(0)(2).io.scalarIn(2)
    ssbs(0)(2).io.outs(12) <> lcus(0)(2).io.scalarIn(3)
    ssbs(0)(2).io.outs(13) <> cus(0)(1).io.scalarIn(0)
  }
}
