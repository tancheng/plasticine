...
trait PlasticineArch2 extends PlasticineArch1 {
  def connect2(io:PlasticineIO, argOutMuxIns:Array[Array[DecoupledIO[UInt]]], doneOuts:Array[Bool], cus:Array[Array[CU]], scus:Array[Array[ScalarCU]] , mcs:Array[Array[MemoryChannel]], vsbs:Array[Array[VectorSwitch]], ssbs:Array[Array[ScalarSwitch]], csbs:Array[Array[ControlSwitch]], lcus:Array[Array[SwitchCU]]):Unit = {
    ...
    vsbs(2)(0).io.outs(5) <> vsbs(2)(1).io.ins(10)
    vsbs(2)(0).io.outs(6) <> vsbs(2)(1).io.ins(11)
    vsbs(2)(0).io.outs(7) <> vsbs(2)(1).io.ins(12)
    vsbs(2)(0).io.outs(8) <> vsbs(2)(1).io.ins(13)
    vsbs(2)(0).io.outs(9) <> mcs(1)(0).io.plasticine.vecIn
    ...
    vsbs(2)(1).io.outs(9) <> mcs(1)(1).io.plasticine.vecIn
    vsbs(2)(1).io.outs(10) <> vsbs(2)(0).io.ins(5)
    vsbs(2)(1).io.outs(11) <> vsbs(2)(0).io.ins(6)
    vsbs(2)(1).io.outs(12) <> vsbs(2)(0).io.ins(7)
    vsbs(2)(1).io.outs(13) <> vsbs(2)(0).io.ins(8)
    vsbs(2)(1).io.outs(14) <> cus(1)(0).io.vecIn(1)
    ...
    cus(0)(1).io.scalarOut(3) <> ssbs(0)(1).io.ins(8)
    cus(1)(0).io.scalarOut(0) <> ssbs(1)(1).io.ins(14)
    cus(1)(0).io.scalarOut(1) <> ssbs(2)(1).io.ins(17)
