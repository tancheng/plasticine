...
trait PlasticineArch4 extends PlasticineArch3 {
  def connect4(io:PlasticineIO, argOutMuxIns:Array[Array[DecoupledIO[UInt]]], doneOuts:Array[Bool], cus:Array[Array[CU]], scus:Array[Array[ScalarCU]] , mcs:Array[Array[MemoryChannel]], vsbs:Array[Array[VectorSwitch]], ssbs:Array[Array[ScalarSwitch]], csbs:Array[Array[ControlSwitch]], lcus:Array[Array[SwitchCU]]):Unit = {
    ...
    ssbs(0)(2).io.outs(14) <> ssbs(0)(1).io.ins(4)
    ssbs(0)(2).io.outs(15) <> ssbs(0)(1).io.ins(5)
    ssbs(0)(2).io.outs(16) <> ssbs(0)(1).io.ins(6)
    ssbs(0)(2).io.outs(17) <> ssbs(0)(1).io.ins(7)
    ssbs(1)(0).io.outs(0) <> ssbs(0)(0).io.ins(9)
    ssbs(1)(0).io.outs(1) <> ssbs(0)(0).io.ins(10)
    ssbs(1)(0).io.outs(2) <> ssbs(0)(0).io.ins(11)
    ssbs(1)(0).io.outs(3) <> ssbs(0)(0).io.ins(12)
    ...
    ssbs(1)(1).io.outs(0) <> ssbs(0)(1).io.ins(9)
    ssbs(1)(1).io.outs(1) <> ssbs(0)(1).io.ins(10)
    ssbs(1)(1).io.outs(2) <> ssbs(0)(1).io.ins(11)
    ssbs(1)(1).io.outs(3) <> ssbs(0)(1).io.ins(12)
