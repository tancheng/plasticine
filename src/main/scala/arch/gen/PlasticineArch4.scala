...
trait PlasticineArch4 extends PlasticineArch3{
  def connect4(io:PlasticineIO, argOutMuxes:List[MuxN], cus:Array[Array[CU]], vsbs:Array[Array[VectorSwitch]], ssbs:Array[Array[ScalarSwitch]], csbs:Array[Array[ControlSwitch]]):Unit = {
    ...
    ssbs(1)(2).io.outs(4).bits <> argOutMuxes(0).io.ins(4)
    ssbs(1)(2).io.outs(4).bits <> argOutMuxes(1).io.ins(4)
    ssbs(1)(2).io.outs(4).bits <> argOutMuxes(2).io.ins(4)
...
//    ssbs(2)(0).io.outs(12) <> cus(2)(0).io.scalarIn(3)
    ssbs(2)(0).io.outs(13).bits <> argOutMuxes(0).io.ins(2)
    ssbs(2)(0).io.outs(13).bits <> argOutMuxes(1).io.ins(2)
    ssbs(2)(0).io.outs(13).bits <> argOutMuxes(2).io.ins(2)
...
//    ssbs(2)(1).io.outs(12) <> cus(2)(1).io.scalarIn(3)
    ...
    ssbs(2)(2).io.outs(4).bits <> argOutMuxes(0).io.ins(5)
    ssbs(2)(2).io.outs(4).bits <> argOutMuxes(1).io.ins(5)
    ssbs(2)(2).io.outs(4).bits <> argOutMuxes(2).io.ins(5)
