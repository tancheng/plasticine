...
trait GeneratedParams1 {
  ...
  def genParams1:Unit = {
    ...
    switchCUParams(0)(0) = GeneratedSwitchCUParams(4, 2, 8, 3)
    switchCUParams(0)(1) = GeneratedSwitchCUParams(4, 2, 8, 3)
    switchCUParams(0)(2) = GeneratedSwitchCUParams(4, 2, 8, 3)
    switchCUParams(1)(0) = GeneratedSwitchCUParams(4, 2, 8, 3)
    switchCUParams(1)(1) = GeneratedSwitchCUParams(4, 2, 8, 3)
    switchCUParams(1)(2) = GeneratedSwitchCUParams(4, 2, 8, 3)
    switchCUParams(2)(0) = GeneratedSwitchCUParams(4, 2, 8, 3)
    switchCUParams(2)(1) = GeneratedSwitchCUParams(4, 2, 8, 3)
    switchCUParams(2)(2) = GeneratedSwitchCUParams(4, 2, 8, 3)
  }
}
