...
trait GeneratedParams1 {
  ...
  def genParams1:Unit = {
    ...
    scalarCUParams(2)(0) = GeneratedScalarCUParams(4, 2, 8, 4)
    scalarCUParams(2)(1) = GeneratedScalarCUParams(4, 2, 8, 4)
    scalarCUParams(2)(2) = GeneratedScalarCUParams(4, 2, 8, 4)
  }
}
