...
trait GeneratedParams1 {
  ...
  def genParams1:Unit = {
    ...
    scalarCUParams(0)(0) = GeneratedScalarCUParams(0, 0, 0, 0)
    scalarCUParams(0)(1) = GeneratedScalarCUParams(0, 0, 0, 0)
    scalarCUParams(0)(2) = GeneratedScalarCUParams(0, 0, 0, 0)
    scalarCUParams(1)(0) = GeneratedScalarCUParams(0, 0, 0, 0)
    scalarCUParams(1)(1) = GeneratedScalarCUParams(0, 0, 0, 0)
    scalarCUParams(1)(2) = GeneratedScalarCUParams(0, 0, 0, 0)
  }
}
