...
public:
  ...
  virtual void tick() {
    ...
    do {
      ...
      switch ((SIM_CMD) cmd) {
        case RESET: 
		  cout << "RESETINGGGGG" << endl;
          reset(); is_reset = true; exit = true; break;
        case STEP: 
		  cout << "STEPPINGGGGG" << endl;
          while(!recv_tokens()); step(); exit = true; break;
        case UPDATE: 
		  cout << "UPDATINGGGGG" << endl;
          while(!recv_tokens()); update(); exit = true; break;
        case POKE: cout << "POKINGGGGG" << endl; poke(); break;
        case PEEK: cout << "PEEKINGGGGG" << endl; peek(); break;
        case FORCE: cout << "FORCINGGGGG" << endl; poke(true); break;
        case GETID: cout << "GETIDINGGGGG" << endl; getid(); break;
		case GETCHK: cout << "GETCHKKINGGGGG" << endl; getchk(); break;
        case SETCLK: cout << "SETCLKINGGGGG" << endl; setclk(); break;
        case FIN: cout << "FINISHINGGGGG" << endl; finish(); exit = true; break;
        default: break;
      }
    } while (!exit);
  }
