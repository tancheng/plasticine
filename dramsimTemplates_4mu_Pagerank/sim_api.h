...
//		cout << ">>>>>>>>>> start reseting control signals <<<<<<<<<<" << endl;
...
//    TileLoader_DRAMSimulator__io_vldOut.values[0] = 0;
//    TileLoader_DRAMSimulator_1__io_vldOut.values[0] = 0;
//    TileLoader_DRAMSimulator_2__io_vldOut.values[0] = 0;
//    TileLoader_DRAMSimulator_3__io_vldOut.values[0] = 0;
