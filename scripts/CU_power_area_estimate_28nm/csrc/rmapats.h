...
struct iptmpl {
    QIRD  * I642;
    struct vcs_globals_t * I643;
    void * I645;
    UP  I646;
    UP  I647;
    struct iptmpl * I638[2];
};
typedef unsigned long long FileOffset;
typedef struct _hsimPeriodL {
    char  I804[256];
    struct _hsimPeriodL * I774;
} HsimPeriodL;
typedef struct {
    U   I806[2];
    U  I807 :1;
...
typedef struct TableAssign_ {
    struct TableAssign_ * I774;
    struct TableAssign_ * I694;
    U  I5;
    U  iinput;
    RP  ptable;
    RP  I868;
...
struct dummyq_struct {
    ...
    struct futq * I936;
    struct futq * I937;
    struct sched_table * I938;
    struct millenium * I940;
    EBLK  * I942;
    EBLK  * I943;
    EBLK  * I944;
    EBLK  * I945;
...
extern "C" {
#endif
void  hsM_0_0(UB  * pcode, vec32  * I842, U  I782);
void  hsM_1_0(UB  * pcode, scalar  val);
void  hsM_2_0(UB  * pcode, vec32  * I842, U  I782);
void  hsM_3_0(UB  * pcode, vec32  * I842, U  I782);
...
void  hsM_8_0(UB  * pcode, vec32  * I842, U  I782);
